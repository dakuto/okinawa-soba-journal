      ...
      <article className="prose prose-slate max-w-none">
        ...
        <div className="space-y-8 text-ryukyu-deep-sea leading-relaxed">
          ...
          <section>
            ...
            <p className="text-sm md:text-base">
              当ブログでは、サイトの利用状況の把握やパフォーマンスの改善に役立てるため、Vercelによるアクセス解析ツール（Vercel
              Analytics）等を利用しています。
              <br />
              これらは匿名でデータを収集しており、ユーザー個人を特定するものではありません。
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-sm md:text-base">
              当ブログのコンテンツ・情報について、できる限り正確な情報を提供するよう努めておりますが、正確性や安全性を保証するものではありません。掲載された内容によって生じた損害等の一切の責任を負いかねますのでご了承ください。
              <br />
              また、当ブログからリンク等で移動した先のサイトで提供される情報、サービス等について一切の責任を負いません。
            </p>
          </section>
        </div>
      </article>
